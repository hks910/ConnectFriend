...
@section('content')
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><strong>@lang('lang.fields_of_work'): </strong>{{ implode(', ', json_decode(Auth::user()->fields_of_work, true)) }}</li>
            ...
            <div class="col-md-6">
                ...
                <form method="POST" action="{{ route('user.visibility.toggle') }}" id="visibilityForm" class="d-flex align-items-center">
                    @csrf
                    <div class="form-check form-switch mt-3">
                        <input class="form-check-input" type="checkbox" id="profileVisibilityToggle" {{ Auth::user()->visibility ? 'checked' : '' }}>
                        <label class="form-check-label" for="profileVisibilityToggle">
                            {{ Auth::user()->visibility ? __('lang.make_profile_invisible').' for 50 Coins' : __('lang.make_profile_visible').' for 5 Coins' }}
                        </label>
                    </div>
                </form>
        ...
        <div class="mb-4">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <form method="POST" action="{{ route('user.avatar.change') }}">
                        @csrf
        ...
        <div class="text-center">
            <a href="{{ route('market.avatar') }}" class="btn btn-primary">@lang('lang.buy_new_avatar')</a>
        </div>
    </div>
